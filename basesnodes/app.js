...
var Monstrarmenu = function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            console.log('---------------------------\n'.green);
                            return [4 /*yield*/, inquirer.prompt(menuopt)];
                        case 1:
                            otp = _a.sent();
                            return [2 /*return*/, { otp: otp }];
                    }
                });
            }); })];
    });
}); };
var pausa = function () { return __awaiter(void 0, void 0, void 0, function () {
    var question;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
